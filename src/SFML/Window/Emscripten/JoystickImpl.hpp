...
#ifndef SFML_JOYSTICKIMPLEM_HPP
#define SFML_JOYSTICKIMPLEM_HPP
...
private:
    static EM_BOOL joystick_connect_disconnect_callback(int eventType, const EmscriptenGamepadEvent *e, void *userData);
