/**
 * Loader generated by glad 2.0.0-beta on Sun Feb 13 16:58:22 2022
 *
 * Generator: C/C++
 * Specification: wgl
 * Extensions: 10
 ...
 *
 * Commandline:
 *    --api='wgl=1.0' --extensions='WGL_ARB_create_context,WGL_ARB_create_context_profile,WGL_ARB_extensions_string,WGL_ARB_framebuffer_sRGB,WGL_ARB_multisample,WGL_ARB_pbuffer,WGL_ARB_pixel_format,WGL_EXT_extensions_string,WGL_EXT_framebuffer_sRGB,WGL_EXT_swap_control' c --alias --header-only --loader
 *
 * Online:
